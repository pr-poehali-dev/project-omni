...
const plans = [
  {
    name: "Самовывоз",
    description: "Заберите растение самостоятельно из нашего питомника",
    price: "Бесплатно",
    period: "",
    features: ["Доступно в Москве", "Выбор растения на месте", "Консультация специалиста", "Упаковка включена"],
    cta: "Узнать адрес",
    highlighted: false,
  },
  {
    name: "Стандарт",
    description: "Быстрая доставка по Москве и Подмосковью",
    price: "390 ₽",
    period: "/заказ",
    features: [
      "Доставка 1–2 дня",
  ...
  {
    name: "По России",
    description: "Доставка в любой город страны",
    price: "от 590 ₽",
    period: "",
    features: [
      "Все города России",
      "Доставка 2–5 дней",
      "Термоупаковка для зимы",
      "Отслеживание заказа",
      "Гарантия живой доставки",
      "Поддержка 24/7",
      "Замена или возврат",
    ],
    ...
    <section id="pricing" className="px-6 py-24">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">Доставка</p>
          ...
          <p className="text-zinc-500 max-w-xl mx-auto text-balance text-lg">
            Выберите удобный способ получения. Растение доедет живым — это гарантируем.
          </p>
        </div>
